...
| 模块 | 技术方案 | 负责 |
|------|---------|------|
| ⚙️ 底层控制 | ESP32 + STM32 | 6++ |
| 👁️ 物块识别 | YOLOv8 | 视觉同学zzp |
| 🗺️ SLAM + 导航 | ROS2 + Cartographer | TBD |
| 🧠 大脑（板载电脑） | 待定 | 团队 |
...
| 角色 | 姓名 | 职责 |
|------|------|------|
| ⚙️ STM32 | 6++ | STM32 底层控制 + 电机/舵机/夹爪/串口通信 |
| 👁️ 视觉 | zzp | YOLO 模型训练 + 部署推理 |
| 🗺️ SLAM | TBD | ROS2 + SLAM 建图 + 导航规划 |
